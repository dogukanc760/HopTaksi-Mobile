...
class _kayitOlState extends State<kayitOl> {
  ...
  Future<void> login(String mail, String password, String name,
  String surname, String gsm, BuildContext context) async {
    ...
    final response = await http.post(
      ...
      body: jsonEncode(
          <String, String>{'name':name, 'surname':surname,'gsm': gsm, 'mail': mail, 'password': password, 'img':''}),
    );
              ...
              child: Column(
                children: [
                  ...
                  Container(
                    ...
                    child: RaisedButton(
                      onPressed: () {
                        login('mail', passwordEditor.text, nameEditor.text, surnameEditor.text, numPhoneEditor.text, context);
                      },
